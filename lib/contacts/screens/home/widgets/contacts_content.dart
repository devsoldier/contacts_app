...
class ContactsContent extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ContactsContent> createState() => _ContactsContentState();
}

class _ContactsContentState extends ConsumerState<ContactsContent> {
  int? page;
  int? pageSize;
  int? currentPage = 1;
      ...
      return Expanded(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                  height: 300, width: 300, 'assets/images/empty_contacts.png'),
              const Padding(
                ...
                return GestureDetector(
                  ...
                  child: Slidable(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        contentPadding:
                            const EdgeInsets.only(bottom: 5, right: 5, top: 5),
                        leading: SizedBox(
                          height: 55,
                          width: 55,
                          child: CircleAvatar(
                            child: ClipRRect(
                              ...
                              child: (state.contactsDetails![index]!.avatar !=
                                      null)
                                  ? Image.network(
                                      height: 55,
                                      width: 55,
